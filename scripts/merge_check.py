...
FILE_PREFIX = config["_03FILE_PREFIX"]  # The part before the number (e.g., "chapter_")
folder = config["_03folder"] 
DESTINATION = config["_03DESTINATION"]  # The name of the resulting file
# =================================================
