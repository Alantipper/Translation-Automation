...
FILE_PREFIX = config["03FILE_PREFIX"]  # The part before the number (e.g., "chapter_")
folder = config["03folder"] 
DESTINATION = config["03DESTINATION"]  # The name of the resulting file
# =================================================
