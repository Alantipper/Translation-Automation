...
FILE_PREFIX = config["_02FILE_PREFIX"]  # The part before the number (e.g., "chapter_")
folder = config["_02folder"] 
DESTINATION = config["_02DESTINATION"]  # The name of the resulting file
# =================================================
