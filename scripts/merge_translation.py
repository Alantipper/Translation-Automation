...
FILE_PREFIX = config["02FILE_PREFIX"]  # The part before the number (e.g., "chapter_")
folder = config["02folder"] 
DESTINATION = config["02DESTINATION"]  # The name of the resulting file
# =================================================
