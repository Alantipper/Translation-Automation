...
python scripts/multiprompt_async.py "translate_prompt_file_ch" "AI_response" "02Translate" 3 1
...
python scripts/multiprompt_async.py "acc_check_prompt_file_ch" "AI_response" "03Check" 3 1
...
python scripts/multiprompt_async.py "line_edit_prompt_file_ch" "AI_response" "04Edit" 3 1
